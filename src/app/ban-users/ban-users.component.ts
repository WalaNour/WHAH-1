...
export class BanUsersComponent implements OnInit {
  ...
  trainingCenters : any 
  ngOnInit(): void {
    this._http.httpGetStudents().subscribe((data) => { console.log("this is students ===>",this.students =  data) })
    this._http.httpGetCompanies().subscribe((data) => { console.log("this is comopanies ===>",this.companies =  data) })
    this._http.httpGetTrainingCenter().subscribe((data)=>{console.log("this is training ===>" ,this.trainingCenters =  data)})
